      ...
      <div className="container mx-auto px-6 py-4">
        <div className="flex justify-between items-center">
          <Link to="/" className="flex items-center gap-3 group">
            <div className="bg-gradient-to-br from-purple-600 to-pink-600 p-2 rounded-lg shadow-lg group-hover:shadow-purple-500/50 transition-all">
          ...
          >
            <div className="bg-purple-900/30 p-3 rounded-lg border border-purple-500/30 hover:bg-purple-800/40 hover:border-purple-400/50 transition-all">
              ...
              {totalItems > 0 && (
                <span className="absolute -top-2 -right-2 bg-gradient-to-r from-pink-500 to-purple-500 text-white rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold shadow-lg animate-pulse">
                  {totalItems}
                </span>
              )}
            </div>
